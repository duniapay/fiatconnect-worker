...
function default_1(job) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { quoteId, transferAddress, userAddress, transferType, fiatAccountId, } = job.data; //Get data fed from the queue.
        const status = fiatconnect_types_1.TransferStatus.TransferStarted;
        try {
            /// Load Repository
            ...
            const entity = yield db_1.prisma.transfer.upsert({
                where: {
                    quoteId: quoteId,
                },
                update: {
                ...
                create: {
                    ...
                    status: status,
                    amountProvided: (_a = quote.cryptoAmount) !== null && _a !== void 0 ? _a : '0',
                    amountReceived: (_b = quote.fiatAmount) !== null && _b !== void 0 ? _b : '0',
                    txHash: '',
                    fee: quote.fee || '0',
                    events: [status],
                },
            });
            logger_1.logger.warn(`Processing Transfer status update complete: ${entity.transferStatus}`);
...
//# sourceMappingURL=tx-started.js.map