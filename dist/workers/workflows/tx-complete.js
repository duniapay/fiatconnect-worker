...
function default_1(job) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const status = fiatconnect_types_1.TransferStatus.TransferComplete;
        try {
            ...
            logger_1.logger.warn(`Transfer status updated: ${entity.transferStatus}`);
            ...
            logger_1.logger.warn('Could not create a record in Route53', error);
            throw error;
        }
    });
}
exports.default = default_1;
//# sourceMappingURL=tx-complete.js.map